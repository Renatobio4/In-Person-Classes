...
with open('image-gallery.html', 'w') as file:
    file.write(f'''
        <div style="display:inline-block;width:200px;height:auto;">
        <img style="width:200px;height:auto;" src="{image1}">
        </div>
        <hr>
        ''')
...
for value in gallery:
    ...
    with open('image-gallery.html', 'a') as file:
        file.write(f'''
        <div style="display:inline-block;width:200px;height:auto;">
        <img style="width:200px;height:auto;" src="{value}">
        <br>{similarity}
        </div>
        ''')
